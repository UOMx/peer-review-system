                                    ...
                                    <div class="pricing">
                                        ...
                                        <div class="x_content">
                                            <div class="">
                                                <div class="pricing_features" style="min-height: 0px;">
                                                    <ul class="list-unstyled text-left">
                                                        @if((($course->description)!=null or ($course->description)!=''))
                                                            <li><i class="fa fa-circle-o text-danger"></i>

                                                                <strong>{{$course->description}}</strong></li>
                                                        @endif

                                                        <li><i class="fa fa-circle-o text-danger"></i>
                                                            <strong> {{count($course->assignments)}} </strong> Assignments Available
                                                        </li>
                                            ...
                                            <div class="pricing_footer">
                                                ...
                                                <a href="#" class="btn btn-primary btn-block" > Enroll <span> now!</span></a>
