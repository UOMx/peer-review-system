                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_content">
                                        <div id="database-fixed-header_wrapper"
                                             class="dataTables_wrapper from-inline dt-bootstrap no-footer">
                                            ...
                                            @for($i=0;$i<$size;$i+=1)
                                                ...
                                                ?>
                                                @if($tab==$i)
                                                    <div role="tabpane{{$i}}" class="tab-pane fade active in"
                                                         id="tab_content{{$i}}" aria-labelledby="block1-tab">
                                                        @else
                                                            <div role="tabpane{{$i}}" class="tab-pane fade"
                                                                 id="tab_content{{$i}}" aria-labelledby="block1-tab">
                                                                @endif
                                                                <div class="row">
                                                                        ...
                                                                        <table id="datatable-fixed-header"
                                                                            ...
                                                                            <tr role="row">
                                                                                <th class="sorting" tabindex="0"
                                                                                    ...
                                                                                    style="width: 97.2px;">Student Name
                                                                                </th>
                                                                                <th class="sorting" tabindex="0"
                                                                                    aria-controls="datatable-fixed-header"
                                                                                    rowspan="1" colspan="1"
                                                                                    aria-label="Position: activate to sort column ascending"
                                                                                    style="width: 143.2px;">Grade
                                                                                </th>
                                                                                <th class="sorting" tabindex="0"
                                                                                    aria-controls="datatable-fixed-header"
                                                                                    rowspan="1" colspan="1"
                                                                                    aria-label="Office: activate to sort column ascending"
                                                                                    style="width: 91.2px;">Feedback Rate
                                                                                </th>
